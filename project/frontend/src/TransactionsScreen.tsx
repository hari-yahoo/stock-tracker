...
import type { Trade, TradeStatus } from './trades'
          ...
          <div className="holdings-grid transactions-grid">
            ...
            {selectedTrade && (
              <aside className="holding-detail transaction-detail">
                ...
                {selectedTrade.exitPlan && (
                  <div className="trade-notes">
                    <span>Exit plan</span>
                    <p>
                      {selectedTrade.exitPlan.status} · target {formatMoney(selectedTrade.exitPlan.targetPrice, selectedTrade.instrument.quoteCurrency)} by {formatDate(selectedTrade.exitPlan.targetDate)}
                    </p>
                    <p>{selectedTrade.exitPlan.rationale}</p>
                  </div>
                )}
